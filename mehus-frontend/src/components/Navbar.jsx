...
export default function Navbar() {
  ...
  const isInfoActive = ["/about", "/gallery", "/contact"].includes(location.pathname);
      ...
      <div className="container-fluid px-4">
        ...
        <div className="collapse navbar-collapse" id="mainNav">
          <ul className="navbar-nav mx-auto align-items-lg-center">
            {[
              ["Home", "/", "bi-house-door"],
              // About, Gallery, Contact removed from here (they will be inside dropdown)
            ...
            {/* ✅ Dropdown: About / Gallery / Contact */}
            <li className="nav-item dropdown mx-1">
              <a
                className={`nav-link d-flex align-items-center py-3 px-3 rounded-pill dropdown-toggle ${
                  isInfoActive ? "active-link" : "inactive-link"
                }`}
                href="#"
                role="button"
              ...
              <ul className="dropdown-menu shadow border-0" style={{ borderRadius: "14px" }}>
                <li>
                  <NavLink className="dropdown-item py-2" to="/about">
                    <i className="bi bi-info-circle me-2"></i> About
                  </NavLink>
                </li>
                <li>
                  <NavLink className="dropdown-item py-2" to="/gallery">
                    <i className="bi bi-images me-2"></i> Gallery
                  </NavLink>
                </li>
                <li>
                  <NavLink className="dropdown-item py-2" to="/contact">
